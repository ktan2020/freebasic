' This is file gtk-3.4.bi
' (FreeBasic binding for GTK - The GIMP Toolkit version 3.4.4)
'
...
#INCLUDE ONCE "gdk/gdk.bi" '__HEADERS__: gdk/gdk.h
...
#INCLUDE ONCE "atk/atk.bi" '__HEADERS__: atk/atk.h
...
TYPE _GtkWidgetClass
  ...
  touch_event AS FUNCTION(BYVAL AS GtkWidget PTR, BYVAL AS GdkEventTouch PTR) AS gboolean
...
DECLARE SUB _gtk_misc_get_padding_and_border(BYVAL AS GtkMisc PTR, BYVAL AS GtkBorder PTR)
...
TYPE _GtkAccessibleClass
  ...
  widget_set AS SUB(BYVAL AS GtkAccessible PTR)
  widget_unset AS SUB(BYVAL AS GtkAccessible PTR)
  _gtk_reserved3 AS SUB()
  _gtk_reserved4 AS SUB()
END TYPE
...
TYPE _GtkActionableInterface
  ...
  get_action_name AS FUNCTION(BYVAL AS GtkActionable PTR) AS CONST gchar PTR
  set_action_name AS SUB(BYVAL AS GtkActionable PTR, BYVAL AS CONST gchar PTR)
  get_action_target_value AS FUNCTION(BYVAL AS GtkActionable PTR) AS GVariant PTR
  set_action_target_value AS SUB(BYVAL AS GtkActionable PTR, BYVAL AS GVariant PTR)
END TYPE
...
DECLARE SUB gtk_stock_add(BYVAL AS CONST GtkStockItem PTR, BYVAL AS guint)
...
DECLARE SUB _gtk_cell_renderer_class_set_accessible_type(BYVAL AS GtkCellRendererClass PTR, BYVAL AS GType)
DECLARE FUNCTION _gtk_cell_renderer_get_accessible_type(BYVAL AS GtkCellRenderer PTR) AS GType
...
#IF (DEFINED(__SIZEOF_INT__)  AND DEFINED(__SIZEOF_POINTER__))  AND (__SIZEOF_INT__ = __SIZEOF_POINTER__)
  AS guint padding(1)
#ENDIF ' (DEFINED(__SIZE...
END TYPE
...
DECLARE FUNCTION gtk_entry_completion_compute_prefix(BYVAL AS GtkEntryCompletion PTR, BYVAL AS CONST ZSTRING PTR) AS gchar PTR
...
TYPE _GtkComboBoxClass
  ...
  format_entry_text AS FUNCTION(BYVAL AS GtkComboBox PTR, BYVAL AS CONST gchar PTR) AS gchar PTR
  _gtk_reserved1 AS SUB()
  _gtk_reserved2 AS SUB()
  _gtk_reserved3 AS SUB()
END TYPE
...
TYPE _GtkColorChooserInterface
  ...
  get_rgba AS SUB(BYVAL AS GtkColorChooser PTR, BYVAL AS GdkRGBA PTR)
  set_rgba AS SUB(BYVAL AS GtkColorChooser PTR, BYVAL AS CONST GdkRGBA PTR)
  add_palette AS SUB(BYVAL AS GtkColorChooser PTR, BYVAL AS GtkOrientation, BYVAL AS gint, BYVAL AS gint, BYVAL AS GdkRGBA PTR)
  color_activated AS SUB(BYVAL AS GtkColorChooser PTR, BYVAL AS CONST GdkRGBA PTR)
  AS gpointer padding(11)
END TYPE
...
DECLARE SUB gtk_render_insertion_cursor(BYVAL AS GtkStyleContext PTR, BYVAL AS cairo_t PTR, BYVAL AS gdouble, BYVAL AS gdouble, BYVAL AS PangoLayout PTR, BYVAL AS INTEGER, BYVAL AS PangoDirection)
...
DECLARE FUNCTION _gtk_range_get_wheel_delta(BYVAL AS GtkRange PTR, BYVAL AS GdkEventScroll PTR) AS gdouble
DECLARE SUB _gtk_range_set_has_origin(BYVAL AS GtkRange PTR, BYVAL AS gboolean)
DECLARE FUNCTION _gtk_range_get_has_origin(BYVAL AS GtkRange PTR) AS gboolean
...
DECLARE SUB _gtk_spin_button_get_panels(BYVAL AS GtkSpinButton PTR, BYVAL AS GdkWindow PTR PTR, BYVAL AS GdkWindow PTR PTR)
...
#DEFINE GTK_BINARY_AGE (404)
#DEFINE GTK_INTERFACE_AGE (4)
#DEFINE GTK_CHECK_VERSION(major,minor,micro) _
    (GTK_MAJOR_VERSION_  > (major)  ORELSE _
     (GTK_MAJOR_VERSION_ = (major)  ANDALSO GTK_MINOR_VERSION_  > (minor))  ORELSE _
     (GTK_MAJOR_VERSION_ = (major)  ANDALSO GTK_MINOR_VERSION_ = (minor)  ANDALSO _
      GTK_MICRO_VERSION_  >= (micro)))
...
' Translated at 12-08-19 17:54:29, by h_2_bi (version 0.2.2.1,
' released under GPLv3 by Thomas[ dot ]Freiherr{ at }gmx[ dot ]net)

'   Protocol: GTK-3.4.bi
' Parameters: GTK-3.4
'                                  Process time [s]: 6.3387420658255
'                                  Bytes translated: 751881
'                                      Maximum deep: 8
'                                SUB/FUNCTION names: 3812
'                                mangled TYPE names: 1
' GtkThemingEnginePrivate
'                                        files done: 216
' gtk+-3.4.4/gtk/gtk.h
' gtk+-3.4.4/gtk/gtkaboutdialog.h
' gtk+-3.4.4/gtk/gtkdialog.h
' gtk+-3.4.4/gtk/gtkwindow.h
' gtk+-3.4.4/gtk/gtkapplication.h
' gtk+-3.4.4/gtk/gtkwidget.h
' gtk+-3.4.4/gtk/gtkaccelgroup.h
' gtk+-3.4.4/gtk/gtkenums.h
' gtk+-3.4.4/gtk/gtkborder.h
' gtk+-3.4.4/gtk/gtktypes.h
' gtk+-3.4.4/gtk/gtkbin.h
' gtk+-3.4.4/gtk/gtkcontainer.h
' gtk+-3.4.4/gtk/gtkaccellabel.h
' gtk+-3.4.4/gtk/gtklabel.h
' gtk+-3.4.4/gtk/gtkmisc.h
' gtk+-3.4.4/gtk/gtkmenu.h
' gtk+-3.4.4/gtk/gtkmenushell.h
' gtk+-3.4.4/gtk/gtkaccelmap.h
' gtk+-3.4.4/gtk/gtkaccessible.h
' gtk+-3.4.4/gtk/gtkaction.h
' gtk+-3.4.4/gtk/gtkactionable.h
' gtk+-3.4.4/gtk/gtkactiongroup.h
' gtk+-3.4.4/gtk/gtkstock.h
' gtk+-3.4.4/gtk/gtkactivatable.h
' gtk+-3.4.4/gtk/gtkadjustment.h
' gtk+-3.4.4/gtk/gtkalignment.h
' gtk+-3.4.4/gtk/gtkappchooser.h
' gtk+-3.4.4/gtk/gtkappchooserdialog.h
' gtk+-3.4.4/gtk/gtkappchooserwidget.h
' gtk+-3.4.4/gtk/gtkbox.h
' gtk+-3.4.4/gtk/gtkappchooserbutton.h
' gtk+-3.4.4/gtk/gtkcombobox.h
' gtk+-3.4.4/gtk/gtktreemodel.h
' gtk+-3.4.4/gtk/gtktreeview.h
' gtk+-3.4.4/gtk/gtktreeviewcolumn.h
' gtk+-3.4.4/gtk/gtkcellrenderer.h
' gtk+-3.4.4/gtk/gtkcelleditable.h
' gtk+-3.4.4/gtk/gtktreesortable.h
' gtk+-3.4.4/gtk/gtkcellarea.h
' gtk+-3.4.4/gtk/gtkdnd.h
' gtk+-3.4.4/gtk/gtkselection.h
' gtk+-3.4.4/gtk/gtktextiter.h
' gtk+-3.4.4/gtk/gtktextattributes.h
' gtk+-3.4.4/gtk/gtktextchild.h
' gtk+-3.4.4/gtk/gtktexttag.h
' gtk+-3.4.4/gtk/gtkentry.h
' gtk+-3.4.4/gtk/gtkeditable.h
' gtk+-3.4.4/gtk/gtkimcontext.h
' gtk+-3.4.4/gtk/gtkentrybuffer.h
' gtk+-3.4.4/gtk/gtkentrycompletion.h
' gtk+-3.4.4/gtk/gtkliststore.h
' gtk+-3.4.4/gtk/gtktreemodelfilter.h
' gtk+-3.4.4/gtk/gtkimage.h
' gtk+-3.4.4/gtk/gtkapplicationwindow.h
' gtk+-3.4.4/gtk/gtkarrow.h
' gtk+-3.4.4/gtk/gtkaspectframe.h
' gtk+-3.4.4/gtk/gtkframe.h
' gtk+-3.4.4/gtk/gtkassistant.h
' gtk+-3.4.4/gtk/gtkbbox.h
' gtk+-3.4.4/gtk/gtkbindings.h
' gtk+-3.4.4/gtk/gtkbuildable.h
' gtk+-3.4.4/gtk/gtkbuilder.h
' gtk+-3.4.4/gtk/gtkbutton.h
' gtk+-3.4.4/gtk/gtkcalendar.h
' gtk+-3.4.4/gtk/gtkcellareabox.h
' gtk+-3.4.4/gtk/gtkcellareacontext.h
' gtk+-3.4.4/gtk/gtkcelllayout.h
' gtk+-3.4.4/gtk/gtkcellrendereraccel.h
' gtk+-3.4.4/gtk/gtkcellrenderertext.h
' gtk+-3.4.4/gtk/gtkcellrenderercombo.h
' gtk+-3.4.4/gtk/gtkcellrendererpixbuf.h
' gtk+-3.4.4/gtk/gtkcellrendererprogress.h
' gtk+-3.4.4/gtk/gtkcellrendererspin.h
' gtk+-3.4.4/gtk/gtkcellrendererspinner.h
' gtk+-3.4.4/gtk/gtkcellrenderertoggle.h
' gtk+-3.4.4/gtk/gtkcellview.h
' gtk+-3.4.4/gtk/gtkcheckbutton.h
' gtk+-3.4.4/gtk/gtktogglebutton.h
' gtk+-3.4.4/gtk/gtkcheckmenuitem.h
' gtk+-3.4.4/gtk/gtkmenuitem.h
' gtk+-3.4.4/gtk/gtkclipboard.h
' gtk+-3.4.4/gtk/gtkcolorbutton.h
' gtk+-3.4.4/gtk/gtkcolorchooser.h
' gtk+-3.4.4/gtk/gtkcolorchooserdialog.h
' gtk+-3.4.4/gtk/gtkcolorchooserwidget.h
' gtk+-3.4.4/gtk/gtkcolorutils.h
' gtk+-3.4.4/gtk/gtkcomboboxtext.h
' gtk+-3.4.4/gtk/gtkcssprovider.h
' gtk+-3.4.4/gtk/gtkcsssection.h
' gtk+-3.4.4/gtk/gtkdebug.h
' gtk+-3.4.4/gtk/gtkdrawingarea.h
' gtk+-3.4.4/gtk/gtkeventbox.h
' gtk+-3.4.4/gtk/gtkexpander.h
' gtk+-3.4.4/gtk/gtkfixed.h
' gtk+-3.4.4/gtk/gtkfilechooser.h
' gtk+-3.4.4/gtk/gtkfilefilter.h
' gtk+-3.4.4/gtk/gtkfilechooserbutton.h
' gtk+-3.4.4/gtk/gtkfilechooserdialog.h
' gtk+-3.4.4/gtk/gtkfilechooserwidget.h
' gtk+-3.4.4/gtk/gtkfontbutton.h
' gtk+-3.4.4/gtk/gtkfontchooser.h
' gtk+-3.4.4/gtk/gtkfontchooserdialog.h
' gtk+-3.4.4/gtk/gtkfontchooserwidget.h
' gtk+-3.4.4/gtk/gtkgradient.h
' gtk+-3.4.4/gtk/gtkstylecontext.h
' gtk+-3.4.4/gtk/gtkstyleprovider.h
' gtk+-3.4.4/gtk/gtkiconfactory.h
' gtk+-3.4.4/gtk/gtkstyleproperties.h
' gtk+-3.4.4/gtk/gtksymboliccolor.h
' gtk+-3.4.4/gtk/gtkgrid.h
' gtk+-3.4.4/gtk/gtkicontheme.h
' gtk+-3.4.4/gtk/gtkiconview.h
' gtk+-3.4.4/gtk/gtktooltip.h
' gtk+-3.4.4/gtk/gtkimagemenuitem.h
' gtk+-3.4.4/gtk/gtkimcontextinfo.h
' gtk+-3.4.4/gtk/gtkimcontextsimple.h
' gtk+-3.4.4/gtk/gtkimmulticontext.h
' gtk+-3.4.4/gtk/gtkinfobar.h
' gtk+-3.4.4/gtk/gtkinvisible.h
' gtk+-3.4.4/gtk/gtklayout.h
' gtk+-3.4.4/gtk/gtklinkbutton.h
' gtk+-3.4.4/gtk/gtklockbutton.h
' gtk+-3.4.4/gtk/gtkmain.h
' gtk+-3.4.4/gtk/gtkmenubar.h
' gtk+-3.4.4/gtk/gtkmenutoolbutton.h
' gtk+-3.4.4/gtk/gtktoolbutton.h
' gtk+-3.4.4/gtk/gtktoolitem.h
' gtk+-3.4.4/gtk/gtksizegroup.h
' gtk+-3.4.4/gtk/gtkmessagedialog.h
' gtk+-3.4.4/gtk/gtkmodules.h
' gtk+-3.4.4/gtk/gtkmountoperation.h
' gtk+-3.4.4/gtk/gtknotebook.h
' gtk+-3.4.4/gtk/gtknumerableicon.h
' gtk+-3.4.4/gtk/gtkoffscreenwindow.h
' gtk+-3.4.4/gtk/gtkorientable.h
' gtk+-3.4.4/gtk/gtkoverlay.h
' gtk+-3.4.4/gtk/gtkpagesetup.h
' gtk+-3.4.4/gtk/gtkpapersize.h
' gtk+-3.4.4/gtk/gtkpaned.h
' gtk+-3.4.4/gtk/gtkprintcontext.h
' gtk+-3.4.4/gtk/gtkprintoperation.h
' gtk+-3.4.4/gtk/gtkprintsettings.h
' gtk+-3.4.4/gtk/gtkprintoperationpreview.h
' gtk+-3.4.4/gtk/gtkprogressbar.h
' gtk+-3.4.4/gtk/gtkradioaction.h
' gtk+-3.4.4/gtk/gtktoggleaction.h
' gtk+-3.4.4/gtk/gtkradiobutton.h
' gtk+-3.4.4/gtk/gtkradiomenuitem.h
' gtk+-3.4.4/gtk/gtkradiotoolbutton.h
' gtk+-3.4.4/gtk/gtktoggletoolbutton.h
' gtk+-3.4.4/gtk/gtkrange.h
' gtk+-3.4.4/gtk/gtkrecentaction.h
' gtk+-3.4.4/gtk/gtkrecentmanager.h
' gtk+-3.4.4/gtk/gtkrecentchooser.h
' gtk+-3.4.4/gtk/gtkrecentfilter.h
' gtk+-3.4.4/gtk/gtkrecentchooserdialog.h
' gtk+-3.4.4/gtk/gtkrecentchoosermenu.h
' gtk+-3.4.4/gtk/gtkrecentchooserwidget.h
' gtk+-3.4.4/gtk/gtkscale.h
' gtk+-3.4.4/gtk/gtkscalebutton.h
' gtk+-3.4.4/gtk/gtkscrollable.h
' gtk+-3.4.4/gtk/gtkscrollbar.h
' gtk+-3.4.4/gtk/gtkscrolledwindow.h
' gtk+-3.4.4/gtk/gtkseparator.h
' gtk+-3.4.4/gtk/gtkseparatormenuitem.h
' gtk+-3.4.4/gtk/gtkseparatortoolitem.h
' gtk+-3.4.4/gtk/gtksettings.h
' gtk+-3.4.4/gtk/gtkshow.h
' gtk+-3.4.4/gtk/gtksizerequest.h
' gtk+-3.4.4/gtk/gtkspinbutton.h
' gtk+-3.4.4/gtk/gtkspinner.h
' gtk+-3.4.4/gtk/gtkstatusbar.h
' gtk+-3.4.4/gtk/gtkstatusicon.h
' gtk+-3.4.4/gtk/gtkswitch.h
' gtk+-3.4.4/gtk/gtktextbuffer.h
' gtk+-3.4.4/gtk/gtktexttagtable.h
' gtk+-3.4.4/gtk/gtktextmark.h
' gtk+-3.4.4/gtk/gtktextbufferrichtext.h
' gtk+-3.4.4/gtk/gtktextview.h
' gtk+-3.4.4/gtk/gtkthemingengine.h
' gtk+-3.4.4/gtk/gtktoolbar.h
' gtk+-3.4.4/gtk/gtktoolitemgroup.h
' gtk+-3.4.4/gtk/gtktoolpalette.h
' gtk+-3.4.4/gtk/gtktoolshell.h
' gtk+-3.4.4/gtk/gtktestutils.h
' gtk+-3.4.4/gtk/gtktreednd.h
' gtk+-3.4.4/gtk/gtktreemodelsort.h
' gtk+-3.4.4/gtk/gtktreeselection.h
' gtk+-3.4.4/gtk/gtktreestore.h
' gtk+-3.4.4/gtk/gtktypebuiltins.h
' gtk+-3.4.4/gtk/gtkuimanager.h
' gtk+-3.4.4/gtk/gtkversion.h
' gtk+-3.4.4/gtk/gtkviewport.h
' gtk+-3.4.4/gtk/gtkvolumebutton.h
' gtk+-3.4.4/gtk/gtkwidgetpath.h
' gtk+-3.4.4/gtk/deprecated/gtkcolorsel.h
' gtk+-3.4.4/gtk/deprecated/gtkcolorseldialog.h
' gtk+-3.4.4/gtk/deprecated/gtkfontsel.h
' gtk+-3.4.4/gtk/deprecated/gtkhandlebox.h
' gtk+-3.4.4/gtk/deprecated/gtkhbbox.h
' gtk+-3.4.4/gtk/deprecated/gtkhbox.h
' gtk+-3.4.4/gtk/deprecated/gtkhpaned.h
' gtk+-3.4.4/gtk/deprecated/gtkhsv.h
' gtk+-3.4.4/gtk/deprecated/gtkhscale.h
' gtk+-3.4.4/gtk/deprecated/gtkhscrollbar.h
' gtk+-3.4.4/gtk/deprecated/gtkhseparator.h
' gtk+-3.4.4/gtk/deprecated/gtkrc.h
' gtk+-3.4.4/gtk/deprecated/gtkstyle.h
' gtk+-3.4.4/gtk/deprecated/gtktable.h
' gtk+-3.4.4/gtk/deprecated/gtktearoffmenuitem.h
' gtk+-3.4.4/gtk/deprecated/gtkvbbox.h
' gtk+-3.4.4/gtk/deprecated/gtkvbox.h
' gtk+-3.4.4/gtk/deprecated/gtkvpaned.h
' gtk+-3.4.4/gtk/deprecated/gtkvscale.h
' gtk+-3.4.4/gtk/deprecated/gtkvscrollbar.h
' gtk+-3.4.4/gtk/deprecated/gtkvseparator.h
'                                      files missed: 0
'                                       __FOLDERS__: 2
' gtk+-3.4.4/gtk/
' gtk+-3.4.4/
'                                        __MACROS__: 14
' 214: #define G_BEGIN_DECLS
' 214: #define G_END_DECLS
' 321: #define G_GNUC_CONST
' 7: #define G_GNUC_MALLOC
' 4: #define G_GNUC_PRINTF( format_idx, arg_idx )
' 65: #define GDK_AVAILABLE_IN_3_2
' 51: #define GDK_AVAILABLE_IN_3_4
' 4: #define GDK_DEPRECATED
' 1: #define GDK_DEPRECATED_IN_3_0
' 77: #define GDK_DEPRECATED_IN_3_0_FOR(x)
' 6: #define GDK_DEPRECATED_IN_3_2
' 35: #define GDK_DEPRECATED_IN_3_2_FOR(x)
' 34: #define GDK_DEPRECATED_IN_3_4
' 38: #define GDK_DEPRECATED_IN_3_4_FOR(x)
'                                       __HEADERS__: 8
' 25: gdk/gdk.h>gdk/gdk.bi
' 4: glib.h>glib.bi
' 10: gio/gio.h>gio/gio.bi
' 2: pango/pango.h>pango/pango.bi
' 14: glib-object.h>glib-object.bi
' 3: cairo.h>cairo.bi
' 2: gdk-pixbuf/gdk-pixbuf.h>gtk/gdk-pixbuf/gdk-pixbuf.bi
' 3: atk/atk.h>atk/atk.bi
'                                         __TYPES__: 0
'                                     __POST_REPS__: 8
' 1: GTK_STOCK_ADD&
' 1: gtk_major_version&
...
' 1: gtk_binary_age&
' 1: gtk_interface_age&
' 1: gtk_check_version&_ ALIAS "gtk_check_version"
' 1: rgba&
