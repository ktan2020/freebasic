''
''
'' gsl_const_num -- header translated with help of SWIG FB wrapper
''
'' NOTICE: This file is part of the FreeBASIC Compiler package and can't
''         be included in other distributions without authorization.
''
''
#ifndef __gsl_const_num_bi__
#define __gsl_const_num_bi__

#define GSL_CONST_NUM_FINE_STRUCTURE (7.297352533e-3)
#define GSL_CONST_NUM_AVOGADRO (6.02214199e23)
