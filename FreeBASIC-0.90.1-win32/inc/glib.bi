...
#INCLUDE ONCE "glibconfig.bi" '__HEADERS__: glibconfig.h
...
DECLARE FUNCTION g_once_init_enter_ ALIAS "g_once_init_enter" (BYVAL AS ANY PTR) AS gboolean
...
DECLARE SUB g_hash_table_add(BYVAL AS GHashTable PTR, BYVAL AS gpointer)
...
DECLARE FUNCTION atexit(BYVAL AS SUB()) AS INTEGER '??? no name for SUB/FUNC

#ENDIF ' (DEFINED(__MING...
...
#IF DEFINED (G_CAN_INLINE) OR DEFINED (__G_UTILS_C__)
#ENDIF ' DEFINED (G_CAN_...
...
DECLARE FUNCTION g_ascii_digit_value(BYVAL AS gchar PTR) AS gint
DECLARE FUNCTION g_ascii_xdigit_value(BYVAL AS gchar PTR) AS gint
...
TYPE _GStaticRecMutex
  ...
  AS guint depth
  AS _GStaticRecMutex_unused unused
END TYPE
...
' Translated at 12-07-24 16:10:24, by h_2_bi (version 0.2.2.1,
' released under GPLv3 by Thomas[ dot ]Freiherr{ at }gmx[ dot ]net)

'   Protocol: GLIB-2.32.4.bi
' Parameters: GLIB-2.32.4
'                                  Process time [s]: 1.739748899126425
'                                  Bytes translated: 303605
'                                      Maximum deep: 5
'                                SUB/FUNCTION names: 1546
'                                mangled TYPE names: 2
' GTestCase
' GTestSuite
'                                        files done: 75
' glib-2.32.4/glib/glib.h
' glib-2.32.4/glib/galloca.h
' glib-2.32.4/glib/gtypes.h
' glib-2.32.4/glib/gmacros.h
' glib-2.32.4/glib/gversionmacros.h
' glib-2.32.4/glib/garray.h
' glib-2.32.4/glib/gasyncqueue.h
' glib-2.32.4/glib/gthread.h
' glib-2.32.4/glib/gatomic.h
' glib-2.32.4/glib/gerror.h
' glib-2.32.4/glib/gquark.h
' glib-2.32.4/glib/gbacktrace.h
' glib-2.32.4/glib/gbase64.h
' glib-2.32.4/glib/gbitlock.h
' glib-2.32.4/glib/gbookmarkfile.h
' glib-2.32.4/glib/gbytes.h
' glib-2.32.4/glib/gcharset.h
' glib-2.32.4/glib/gchecksum.h
' glib-2.32.4/glib/gconvert.h
' glib-2.32.4/glib/gdataset.h
' glib-2.32.4/glib/gdate.h
' glib-2.32.4/glib/gdatetime.h
' glib-2.32.4/glib/gtimezone.h
' glib-2.32.4/glib/gdir.h
' glib-2.32.4/glib/genviron.h
' glib-2.32.4/glib/gfileutils.h
' glib-2.32.4/glib/ggettext.h
' glib-2.32.4/glib/ghash.h
' glib-2.32.4/glib/glist.h
' glib-2.32.4/glib/gmem.h
' glib-2.32.4/glib/ghmac.h
' glib-2.32.4/glib/ghook.h
' glib-2.32.4/glib/ghostutils.h
' glib-2.32.4/glib/giochannel.h
' glib-2.32.4/glib/gmain.h
' glib-2.32.4/glib/gpoll.h
' glib-2.32.4/glib/gslist.h
' glib-2.32.4/glib/gstring.h
' glib-2.32.4/glib/gunicode.h
' glib-2.32.4/glib/gutils.h
' glib-2.32.4/glib/gkeyfile.h
' glib-2.32.4/glib/gmappedfile.h
' glib-2.32.4/glib/gmarkup.h
' glib-2.32.4/glib/gmessages.h
' glib-2.32.4/glib/gnode.h
' glib-2.32.4/glib/goption.h
' glib-2.32.4/glib/gpattern.h
' glib-2.32.4/glib/gprimes.h
' glib-2.32.4/glib/gqsort.h
' glib-2.32.4/glib/gqueue.h
' glib-2.32.4/glib/grand.h
' glib-2.32.4/glib/gregex.h
' glib-2.32.4/glib/gscanner.h
' glib-2.32.4/glib/gsequence.h
' glib-2.32.4/glib/gshell.h
' glib-2.32.4/glib/gslice.h
' glib-2.32.4/glib/gspawn.h
' glib-2.32.4/glib/gstrfuncs.h
' glib-2.32.4/glib/gstringchunk.h
' glib-2.32.4/glib/gtestutils.h
' glib-2.32.4/glib/gthreadpool.h
' glib-2.32.4/glib/gtimer.h
' glib-2.32.4/glib/gtrashstack.h
' glib-2.32.4/glib/gtree.h
' glib-2.32.4/glib/gurifuncs.h
' glib-2.32.4/glib/gvarianttype.h
' glib-2.32.4/glib/gvariant.h
' glib-2.32.4/glib/gversion.h
' glib-2.32.4/glib/gwin32.h
' glib-2.32.4/glib/deprecated/gallocator.h
' glib-2.32.4/glib/deprecated/gcache.h
' glib-2.32.4/glib/deprecated/gcompletion.h
' glib-2.32.4/glib/deprecated/gmain.h
' glib-2.32.4/glib/deprecated/grel.h
' glib-2.32.4/glib/deprecated/gthread.h
'                                      files missed: 3
' alloca.h
' signal.h
' pthread.h
...
' glib-2.32.4/glib/
'                                        __MACROS__: 30
' 72: #define G_BEGIN_DECLS
' 72: #define G_END_DECLS
' 0: #define G_GNUC_EXTENSION
' 0: #define G_CONST_RETURN const
' 50: #define G_GNUC_CONST
' 17: #define G_GNUC_PRINTF( format_idx, arg_idx )
' 86: #define G_GNUC_MALLOC
' 14: #define G_INLINE_FUNC
' 18: #define GLIB_VAR extern
' 0: #define G_GNUC_MAY_ALIAS
' 8: #define G_GNUC_ALLOC_SIZE(x)
' 4: #define G_GNUC_ALLOC_SIZE2(x, y)
' 47: #define G_GNUC_WARN_UNUSED_RESULT
' 9: #define G_GNUC_PURE
' 1: #define G_GNUC_INTERNAL
' 6: #define G_GNUC_FORMAT(x)
' 33: #define GLIB_DEPRECATED
' 12: #define GLIB_DEPRECATED_FOR(x)
' 0: #define GLIB_AVAILABLE_IN_2_26
' 0: #define GLIB_AVAILABLE_IN_2_28
' 22: #define GLIB_AVAILABLE_IN_2_30
' 0: #define GLIB_AVAILABLE_IN_2_32
' 19: #define GLIB_DEPRECATED_IN_2_26
' 0: #define GLIB_DEPRECATED_IN_2_26_FOR(x)
' 0: #define GLIB_DEPRECATED_IN_2_28
' 1: #define GLIB_DEPRECATED_IN_2_28_FOR(x)
' 1: #define GLIB_DEPRECATED_IN_2_30
' 1: #define GLIB_DEPRECATED_IN_2_30_FOR(x)
' 16: #define GLIB_DEPRECATED_IN_2_32
' 19: #define GLIB_DEPRECATED_IN_2_32_FOR(x)
'                                       __HEADERS__: 2
' 1: glibconfig.h>glibconfig.bi
' 1: pthread.h>
'                                         __TYPES__: 0
'                                     __POST_REPS__: 17
' 3: G_STATIC_MUTEX_INIT&
' 1: glib_check_version&_ ALIAS "glib_check_version"
' 1: glib_major_version&_ ALIAS "glib_major_version"
' 1: glib_minor_version&_ ALIAS "glib_minor_version"
' 1: glib_micro_version&_ ALIAS "glib_micro_version"
' 5: g_once_init_leave&_ ALIAS "g_once_init_leave"
' 1: G_STATIC_PRIVATE_INIT&
' 1: G_STATIC_REC_MUTEX_INIT&
' 1: G_STATIC_RW_LOCK_INIT&
' 1: GDateDMY&
' 1: G_DATE_DAY&
' 1: G_DATE_MONTH&
' 1: G_DATE_YEAR&
' 1: G_QUEUE_INIT&
' 1: G_CSET_A_2_Z&
' 1: g_source_remove&_ ALIAS "g_source_remove"
' 2: g_atexit&_ ALIAS "g_atexit"
