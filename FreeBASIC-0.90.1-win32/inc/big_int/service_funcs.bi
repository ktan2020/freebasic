...
declare function big_int_create cdecl alias "big_int_create" (byval len as integer) as big_int ptr
...
declare function big_int_realloc cdecl alias "big_int_realloc" (byval a as big_int ptr, byval len as integer) as integer
